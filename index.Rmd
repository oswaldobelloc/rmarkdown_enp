...
3.  ***Prueba $U$ de Mann-Whitney*** (Sección \@ref(mann-whitney2i))

4.  ***Prueba de las Rachas*** (Sección \@ref(rachas2i))
...
kableExtra::kbl(
  ...
  format.args = list(decimal.mark = ",", big.mark = "."),
  booktabs = TRUE,
  caption = "\\label{tab2:baterias}Tipos de baterias con tiempo de duración (en horas) menores o iguales y mayores que la mediana global",
  escape = FALSE, 
  format = "html"
) %>%
  kable_styling(
...
```{r}
A <- c(132.5, 167.4, 189.8, 124.6, 136.6, 147.5, 159.9,
       117.8, 106.3)
B <- c(97.4, 108.2, 114.1, 86.3, 101.8, 122.6, 78.3, 136.2,
...
kableExtra::kbl(
  ...
  format.args = list(decimal.mark = ",", big.mark = "."),
  booktabs = TRUE,
  caption = "\\label{tab2:baterias}Ventas por establecimiento",
  escape = FALSE, 
  format = "html"
) %>%
  kable_styling(
...
kableExtra::kbl(
  ...
  format.args = list(decimal.mark = ",", big.mark = "."),
  booktabs = TRUE,
  caption = "\\label{tab2:baterias}Establecimientos con ventas menores o iguales y mayores que la mediana global",
  escape = FALSE, 
  format = "html"
) %>%
  kable_styling(
...
```
<br/>
El siguiente script muestra el estadístico y el p.valor de la prueba de la mediana de Mood-Westenberg.
...
###	Racionalización de la Prueba $U$ de Mann-Whitney {#racionalizacion-mann-whitney2i}

### Implementación en `r colorize("R", "blue")` de la Prueba $U$ de Mann-Whitney {#R-mann-whitney2i}

::: {.example #ejemplo1-mann-whitney2i name="Prueba $U$ de Mann-Whitney"}
...
kableExtra::kbl(
  ...
  format.args = list(decimal.mark = ",", big.mark = "."),
  booktabs = TRUE,
  caption = "\\label{tab2:baterias}Ranqueo de las puntuaciones",
  escape = FALSE, 
  format = "html"
) %>%
  kable_styling(
...
```
<br/>
Los estadísticos de la prueba de suma de rangos de Mann-Whitney, se obtiene con el siguiente código.
...
kableExtra::kbl(
  ...
  format.args = list(decimal.mark = ",", big.mark = "."),
  booktabs = TRUE,
  caption = "\\label{tab2:baterias}Estadístico de Mann-Whitney_Wilcoxon para las puntuaciones",
  escape = FALSE, 
  format = "html"
) %>%
  kable_styling(
...
```
<br/>
Note que en la tabla que muestra los datos no hay puntuaciones empatadas, por lo que el cálculo del p.valor exacto de la prueba U de Mann-Whitney-Wilcoxon se obtiene con el siguiente código.
...
```{r}
wilcox.test(x = control, y = experimental, 
...
```{r}
library(exactRankTests)
wilcox.exact(x = control, y = experimental, 
             alternative = "greater", paired = F, 
