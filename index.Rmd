...
5.  ***La Prueba de Rangos Asignados de Wilcoxon*** (Sección \@ref(wilcoxon1))
...
F_{N}\left ( \frac{t + 0,5 }{\sqrt{\sum_{i=1}^{n}R_i^2}}; \; \mu_Z = 0, \sigma_Z = 1 \right ), \; t \le 0
\end{cases}. 
(\#eq:pblzte-wilcoxon1)
\end{equation}
$$
...
kableExtra::kbl(
  ...
  format.args = list(decimal.mark = ",", big.mark = "."),
  booktabs = TRUE,
  caption = "\\label{tab2:co}Ranqueo de la concentración de octano",
  escape = FALSE
) %>%
  kable_styling(
    bootstrap_options = "striped",
...
**Nota:** La función `wilcox.test` no ejecuta la prueba exacta en parecencia de ceros y/o empates.  
