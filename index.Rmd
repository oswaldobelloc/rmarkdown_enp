...
Ahora, si la prueba de hipótesis es bilateral. Es decir, $H_0: \widetilde{\mu}= \widetilde{\mu}_{0}$, $H_1: \widetilde{\mu} \neq \widetilde{\mu}_{0}$. El $p_{valor}$ (aproximado) viene dado por:
...
```{r datos6}
lim_int <- c(
  -Inf, 10.2, 10.3, 10.4, 10.5, 10.6, 10.7,
  10.8, 10.9, Inf
)
...
predichas de los reclusos",
  ...
  row_spec(which(reclusos$diferencia == 0),
    color = "red",
    strikeout = TRUE
  ) %>%
  kable_classic_2("hover") %>%
