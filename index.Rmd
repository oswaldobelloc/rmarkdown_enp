...
2.  ***Prueba de la Mediana*** (Sección \@ref(mediana2r))
...
```
<br/>
La función `fisher.test` del paquete `stats`, permite ejecutar, de manera directa, la prueba de la probabilidad exacta de Fisher, como se muestra en el siguiente código. Fíjese que el $p_{valor}$ obtenido en esta salida es idéntico al anterior.
