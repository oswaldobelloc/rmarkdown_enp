...
## Prueba $U$ de Mann-Whitney {#mann-whitney2i}
...
kableExtra::kbl(
  ...
  format.args = list(decimal.mark = ",", big.mark = "."),
  booktabs = TRUE,
  caption = "\\label{tab2:baterias}Estadístico de Mann-Whitney para las puntuaciones",
  escape = FALSE, 
  format = "html"
) %>%
  kable_styling(
...
```
<br/>
Note que en la tabla que muestra los datos no hay puntuaciones empatadas, por lo que el cálculo del p.valor exacto de la prueba U de Wilcoxon-Mann-Whitney se obtiene con el siguiente código.
...
De manera directa, el estadístico $U$ de Mann-Whitney y el $p_{valor}$ exacto para esta prueba se obtiene con el siguiente código.
